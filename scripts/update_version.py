...
def main():
    ...
    # Note: src/pipeline/__init__.py and src/cli/cli.py now import from version.py
    # so they don't need direct updates
    files_to_update = [
        version_file,
        root / "pyproject.toml",
    ]
    ...
    print("📦 Files updated: version.py, pyproject.toml")
    print("📌 Version automatically propagates to CLI and pipeline via imports")
    print("\n💡 Next steps:")
